...
test.describe("Form Layout page", async () => {
  ...
  test("input fields", async ({ page }) => {
    ...
    await usingTheGridEmailInput.pressSequentially("test3@test.com");
...
test('lists and dropdowns', async ({ page }) => {
  ...
  expect(page.locator('nb-layout-header')).toHaveCSS('background-color', 'rgb(50, 50, 89)');
...
test('tooltips', async ({ page }) => {
  ...
  // page.getByRole('toolbar'); // if you have a role tooltip created
